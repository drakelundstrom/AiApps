...
import type { BillInputChangeEvent, TipCalculatorStyles } from './interfaces'
...
export default function TipCalculator() {
  ...
  const handleBill = useCallback((e: BillInputChangeEvent) => {
  ...
  const handleCustom = useCallback((e: BillInputChangeEvent) => {
    const v = e.target.value.replace(/[^0-9.]/g, '')
    setCustomTip(v)
  }, [])
...
const styles: TipCalculatorStyles = {
  container: {
